...
SUSY_HLT_Ele8_Jet30 = cms.EDAnalyzer("SUSY_HLT_ElecFakes",
  ...
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  HLTProcess = cms.string('HLT'),
  TriggerPath = cms.string('HLT_Ele8_CaloIdM_GsfTrackIdM_PFJet30_v'),
...
SUSY_HLT_Ele8_Jet30_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs   = cms.untracked.vstring("HLT/SUSYBSM/HLT_Ele8_CaloIdM_GsfTrackIdM_PFJet30_v"),
    verbose    = cms.untracked.uint32(2), # Set to 2 for all messages
    resolution = cms.vstring(""),
    efficiency = cms.vstring()
)
...
SUSY_HLT_Ele12_Jet30 = cms.EDAnalyzer("SUSY_HLT_ElecFakes",
  ...
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  HLTProcess = cms.string('HLT'),
  TriggerPath = cms.string('HLT_Ele12_CaloIdM_GsfTrackIdM_PFJet30_v'),
...
SUSY_HLT_Ele12_Jet30_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs   = cms.untracked.vstring("HLT/SUSYBSM/HLT_Ele12_CaloIdM_GsfTrackIdM_PFJet30_v"),
    verbose    = cms.untracked.uint32(2), # Set to 2 for all messages
    resolution = cms.vstring(""),
    efficiency = cms.vstring()
)
...
SUSY_HLT_Ele17_Jet30 = cms.EDAnalyzer("SUSY_HLT_ElecFakes",
  ...
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  HLTProcess = cms.string('HLT'),
  TriggerPath = cms.string('HLT_Ele17_CaloIdM_GsfTrackIdM_PFJet30_v'),
...
SUSY_HLT_Ele17_Jet30_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs   = cms.untracked.vstring("HLT/SUSYBSM/HLT_Ele17_CaloIdM_GsfTrackIdM_PFJet30_v"),
    verbose    = cms.untracked.uint32(2), # Set to 2 for all messages
    resolution = cms.vstring(""),
    efficiency = cms.vstring()
)
...
SUSY_HLT_Ele23_Jet30 = cms.EDAnalyzer("SUSY_HLT_ElecFakes",
  ...
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  HLTProcess = cms.string('HLT'),
  TriggerPath = cms.string('HLT_Ele23_CaloIdM_GsfTrackIdM_PFJet30_v'),
...
SUSY_HLT_Ele23_Jet30_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs   = cms.untracked.vstring("HLT/SUSYBSM/HLT_Ele23_CaloIdM_GsfTrackIdM_PFJet30_v"),
    verbose    = cms.untracked.uint32(2), # Set to 2 for all messages
    resolution = cms.vstring(""),
    efficiency = cms.vstring()
)
...
SUSY_HLT_Ele23_Jet30 = cms.EDAnalyzer("SUSY_HLT_ElecFakes",
  ...
  TriggerResults = cms.InputTag('TriggerResults','','HLT'),
  HLTProcess = cms.string('HLT'),
  TriggerPath = cms.string('HLT_Ele33_CaloIdM_GsfTrackIdM_PFJet30_v'),
  TriggerFilter = cms.InputTag('hltEle33CaloIdMGsfTrackIdMDphiFilter', '', 'HLT'), #the last filter in the path
  TriggerJetFilter = cms.InputTag('hltEle33NoIsoPFJet30EleCleaned', '', 'HLT'), #the last filter in the path                                      
)
SUSY_HLT_Ele23_Jet30_POSTPROCESSING = cms.EDAnalyzer("DQMGenericClient",
    subDirs   = cms.untracked.vstring("HLT/SUSYBSM/HLT_Ele33_CaloIdM_GsfTrackIdM_PFJet30_v"),
    verbose    = cms.untracked.uint32(2), # Set to 2 for all messages
    resolution = cms.vstring(""),
    efficiency = cms.vstring()
)
...
SUSY_HLT_ElecFakes_POSTPROCESSING = cms.Sequence(SUSY_HLT_Ele8_IdL_Iso_Jet30_POSTPROCESSING+
												 ...
												 SUSY_HLT_Ele33_Jet30_POSTPROCESSING)
