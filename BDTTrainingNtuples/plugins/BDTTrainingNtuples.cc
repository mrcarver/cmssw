// -*- C++ -*-
//
// Package:    EMTFAnalyzer/BDTTrainingNtuples
// Class:      BDTTrainingNtuples
// 
/**\class BDTTrainingNtuples BDTTrainingNtuples.cc EMTFAnalyzer/BDTTrainingNtuples/plugins/BDTTrainingNtuples.cc
...
*/
//
// Original Author:  Matt Carver
//         Created:  Tue, 12 Jul 2016 17:08:33 GMT
//
//
...
#include "EMTFAnalyzer/BDTTrainingNtuples/plugins/BDTTrainingNtuples.h"
...
BDTTrainingNtuples::BDTTrainingNtuples(const PSet& p) {
...
void BDTTrainingNtuples::produce(edm::Event& ev,
...
void 
BDTTrainingNtuples::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
BDTTrainingNtuples::endJob() 
{
}
...
DEFINE_FWK_MODULE(BDTTrainingNtuples);
