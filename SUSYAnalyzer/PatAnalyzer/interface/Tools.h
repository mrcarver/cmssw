...
namespace tools {
	...
	double pfRelIso15(const pat::Muon *mu, double myRho);
    double pfRelIso(const pat::Electron *el, double myRho);
	double pfRelIso15(const pat::Electron *el, double myRho);
	double pfRelIso(const pat::Electron *el);
	...
	std::vector<const pat::Electron* > MVALooseElectronSelector(//const std::vector<pat::Electron>  & thePatElectrons,
                                                           ...
                                                           reco::BeamSpot::Point BS, edm::ValueMap<float> valuesMap);//, EGammaMvaEleEstimatorCSA14* myMVATrig);
														   
														   
	//bool isMVATightNoIsoSIP(const pat::Electron  thePatElectron, EGammaMvaEleEstimatorCSA14* myMVATrig);										   													   
														
	
	std::vector<const pat::Electron* > SSSyncElectronSelector(const std::vector<pat::Electron>  & thePatElectrons,
                                                           double v_electron_pt,
                                                           reco::Vertex::Point PV,
                                                           double v_electron_d0,
                                                           bool bool_electron_chargeConsistency,
	...
	bool SSSyncIsTight(const pat::Electron   thePatElectron,
                                                           double v_electron_pt,
                                                           reco::Vertex PV,
                                                           double v_electron_d0,
                                                           bool bool_electron_chargeConsistency,
	...
	bool SSSyncIsTightNoSIP(const pat::Electron   thePatElectron,
                                                           double v_electron_pt,
                                                           reco::Vertex PV,
                                                           double v_electron_d0,
                                                           bool bool_electron_chargeConsistency,
    ...
    std::vector<int> SSSyncElectronSelectorIndex(const std::vector<pat::Electron>  & thePatElectrons,
                                                           double v_electron_pt,
                                                           reco::Vertex::Point PV,
                                                           double v_electron_d0,
                                                           bool bool_electron_chargeConsistency,
	...
	std::vector<const pat::Muon* > SSSyncMuonSelector(const std::vector<pat::Muon>  & thePatMuons,
                                                   double v_muon_pt,
                                                   reco::Vertex::Point PV,
                                                   double v_muon_d0);
												   
	std::vector<const pat::Muon* > MVALooseMuonSelector(const std::vector<pat::Muon>  & thePatMuons,
                                                   double v_muon_pt,
                                                   reco::Vertex::Point PV,
                                                   double v_muon_d0);											   
												   
												   
	bool SSSyncIsTight(const pat::Muon  thePatMuons,
                                                   double v_muon_pt,
                                                   reco::Vertex PV,
                                                   double v_muon_d0,float sip);
												   //reco::TransientTrack theTT);//
	
	bool SSSyncIsTightNoSIP(const pat::Muon  thePatMuons,
                                                   double v_muon_pt,
                                                   reco::Vertex PV,
                                                   double v_muon_d0);
												  // reco::TransientTrack theTT);//
												   
	bool MVAIsTightNoIsoSIP(const pat::Muon  thePatMuons,
                                                   double v_muon_pt,
                                                   reco::Vertex PV,
                                                   double v_muon_d0);
												   //reco::TransientTrack theTT);//											   
	...
	std::vector<int> SSSyncMuonSelectorIndex(const std::vector<pat::Muon>  & thePatMuons,
                                                   double v_muon_pt,
                                                   reco::Vertex::Point PV,
                                                   double v_muon_d0);
	...
	std::vector<const reco::Muon* > EffsMuonSelector(const std::vector<reco::Muon>  & thePatMuons,
                                                   double v_muon_pt,
                                                   reco::Vertex::Point PV,
                                                   double v_muon_d0);
	...
	std::vector<const pat::Electron* > SSOptimizerElectronSelector(const std::vector<pat::Electron>  & thePatElectrons,
                                                           double v_electron_pt,
                                                           reco::Vertex::Point PV,
                                                           double v_electron_d0,
                                                           bool bool_electron_chargeConsistency,
    ...
    std::vector<int> SSOptimizerElectronSelectorIndex(const std::vector<pat::Electron>  & thePatElectrons,
                                                           double v_electron_pt,
                                                           reco::Vertex::Point PV,
                                                           double v_electron_d0,
                                                           bool bool_electron_chargeConsistency,
