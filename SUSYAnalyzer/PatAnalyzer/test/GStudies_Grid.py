...
process.Eff = cms.EDAnalyzer(
	...
	sample = cms.uint32(2),#1-T1tttt1200::2-T1tttt1500::3-T5ttttD
...
#fileOutName = "AllSamples/T1_1500_Out.root"
#fileOutName = "AllSamples/oog.root"
fileOutName = "fuckyou"
...
#process.TFileService = cms.Service("TFileService", fileName = cms.string(fileOutName) )

#process.EffSequence = cms.Sequence(process.goodOfflinePrimaryVertices*process.Eff)*process.SyncExercise
process.EffSequence = cms.Sequence(process.goodOfflinePrimaryVertices*process.SyncExercise)
