...
#inputFile=""
#outputFile=""
##outputFile="SyncOutput/SSSync_Interactive_Full_PHYS14_25_V2_etrial.root"
#def getVal(arg):
##    i=0
...
if isMC:
	...
	process.GlobalTag.globaltag="PHYS14_25_V1::All" # tag fo PHYS14 25ns samples
else:
    #process.GlobalTag.globaltag="GR_P_V40_AN1::All" # tag fo 53X 2012C Prompt Reco (FT_53_V10_AN1) in the future for some runs
    process.GlobalTag.globaltag="FT_53_V6_AN1::All" # tag fo 53X 2012A/B 13Jul2012 rereco
...
process.source = cms.Source ("PoolSource",
							 ...
							 #eventsToProcess = cms.untracked.VEventRange('1:5'),                   
...
#      '/cms/data/store/user/ddidar/MC_JEC53X_Trk/TTTo2L2Nu2B/PatTuple_TTTo2L2Nu2B_8TeV-powheg-pythia6_Summer12_DR53X-PU_S10_START53_V7A-v1_AODSIM_NOSkim_9_2_L6e.root'
#     '/scratch/lfs/lesya/FakeSync_WJets.root'
#     '/scratch/lfs/lesya/FakeSync_TTWJets.root'
#       '/scratch/lfs/lesya/outputs/Fakes/qcdMuEnriched_scdVtx.root'
#      '/cms/data/store/user/lshchuts/MC_JEC53X/QCD_Pt_20_MuEnrichedPt_15/PatTuple_QCD_Pt_20_MuEnrichedPt_15_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v3_AODSIM_NOSkim_126_3_Vuf.root'
#      '/cms/data/store/user/lshchuts/MC_JEC53X/TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_ext2/PatTuple_TTJets_SemiLeptMGDecays_8TeV-madgraph-tauola_Summer12_DR53X-PU_S10_START53_V19_ext2-v1_AODSIM_NOSkim_2568_1_Ndn.root'
...
#      '/cms/data/store/user/ddidar/MC_JEC53X/QCD_Pt_20_MuEnrichedPt_15_CorrectGT/PatTuple_QCD_Pt_20_MuEnrichedPt_15_TuneZ2star_8TeV_pythia6_Summer12_DR53X-PU_S10_START53_V7A-v3_AODSIM_NOSkim_1044_1_HWE.root'
#    '/cms/data/store/mc/Spring14miniaod/TTJets_MSDecaysCKM_central_Tune4C_13TeV-madgraph-tauola/MINIAODSIM/PU20bx25_POSTLS170_V5-v1/00000/003E832C-8AFC-E311-B7AA-002590596490.root'
 #    '/cms/data/store/mc/Spring14miniaod/WZJetsTo3LNu_Tune4C_13TeV-madgraph-tauola/MINIAODSIM/PU20bx25_POSTLS170_V5-v1/00000/B0489445-F63C-E411-8F11-002590200970.root'
