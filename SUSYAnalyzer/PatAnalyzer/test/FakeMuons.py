...
#FakeElectrons
process.FakeElectrons = cms.EDAnalyzer("FakeMuons",#"FakeElectronsUC",
                                       ...
                                       SampleLabel = cms.untracked.string("ElectronsMC")
                                       )
...
process.tauMatch = cms.EDProducer("MCMatcher",
                                  ...
                                  maxDeltaR   = cms.double(0.15),                         # Minimum deltaR for the match.     By default any deltaR is allowed 
                                  maxDPtRel   = cms.double(30.0),                         # Minimum deltaPt/Pt for the match. By default anything is allowed   ( ""  )
