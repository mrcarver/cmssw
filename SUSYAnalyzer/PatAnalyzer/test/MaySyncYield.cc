...
void MaySyncYield()
{
	...
	//TFile *hfiles = new TFile("file:Debugging.root","READ");//
	TFile *hfiles = new TFile("/cms/data/store/user/t2/users/mrcarver/LimitSettingTuples/DYJets_HT600toInf/DYJets_HT600toInf.root","READ");//
	...
	//outputTree->Add("file:Debugging.root");
	outputTree->Add("/cms/data/store/user/t2/users/mrcarver/LimitSettingTuples/DYJets_HT600toInf/DYJets_HT600toInf.root");
	...
	TString fileOutName = "ChargeFlips/"+Sample+"_Yields.root";
